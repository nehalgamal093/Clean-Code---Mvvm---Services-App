...
import 'package:ecommerce_mvvm/presentation/onboarding/viewmodel/onboarding_viewmodel.dart';
...
class _OnBoardingViewState extends State<OnBoardingView> {
      ...
      return Scaffold(
        ...
        body: PageView.builder(
            ...
            itemBuilder: (context, index) {
              return OnBoadringPage(sliderViewObject.sliderObject);
            }),
  ...
  Widget _getProperCircle(int index, int currentIndex) {
    if (index == currentIndex) {
      return SvgPicture.asset(ImageAssets.hollowCirclIc);
    } else {
...
class OnBoadringPage extends StatelessWidget {
  ...
  const OnBoadringPage(this._sliderObject, {super.key});
